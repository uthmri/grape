                            ...
                            bool consider_region_intensity = true)
{
    ...
    // OS check for code compiler, 07/25/2017
#ifdef WIN32
    image::basic_image< ImageType::value_type,ImageType::dimension> crop_image(src);
#else    // code-built for Linux
    image::basic_image< class ImageType::value_type,ImageType::dimension> crop_image(src);
#endif
//    image::basic_image< ImageType::value_type,ImageType::dimension> crop_image(src);
    //image::basic_image< class ImageType::value_type,ImageType::dimension> crop_image(src);//GRAPE 2017-07-12
