...
#ifndef DIAGRAMLINEITEM_H
#define DIAGRAMLINEITEM_H

#include <DiagramBaseItems.h>

class DiagramLineItem : public DiagramTwoPointItem
{
public:
	DiagramLineItem();
	DiagramLineItem(const DiagramLineItem& item);
	virtual ~DiagramLineItem();
...
class DiagramLineItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
	DiagramLineItemDialog(QWidget* parent = NULL, Flags flags = NoFlags);
	~DiagramLineItemDialog();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(DiagramLineItemDialog::Flags)
