...
class DiagramEllipseItem : public DiagramBoxResizeItem
{
public:
	DiagramEllipseItem();
	DiagramEllipseItem(const DiagramEllipseItem& item);
	virtual ~DiagramEllipseItem();
...
class DiagramEllipseItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
	DiagramEllipseItemDialog(QWidget* parent = NULL, Flags flags = NoFlags);
	~DiagramEllipseItemDialog();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(DiagramEllipseItemDialog::Flags)
