...
#ifndef DIAGRAMPOLYLINEITEM_H
#define DIAGRAMPOLYLINEITEM_H

#include <DiagramBaseItems.h>

class DiagramPolylineItem : public DiagramPolyItem
{
public:
	DiagramPolylineItem();
	DiagramPolylineItem(const DiagramPolylineItem& item);
	virtual ~DiagramPolylineItem();
...
class DiagramPolylineItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
	DiagramPolylineItemDialog(QWidget* parent = NULL, Flags flags = NoFlags);
	~DiagramPolylineItemDialog();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(DiagramPolylineItemDialog::Flags)
