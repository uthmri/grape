...
#ifndef DIAGRAMCURVEITEM_H
#define DIAGRAMCURVEITEM_H

#include <DiagramBaseItems.h>

class DiagramCurveItem : public DiagramTwoPointItem
{
public:
	DiagramCurveItem();
	DiagramCurveItem(const DiagramCurveItem& item);
	virtual ~DiagramCurveItem();
...
class DiagramCurveItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
private:
	...
	DiagramPositionLayout* controlPoint0Layout;
	DiagramPositionLayout* controlPoint1Layout;

public:
	DiagramCurveItemDialog(QWidget* parent = NULL, Flags flags = NoFlags);
	~DiagramCurveItemDialog();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(DiagramCurveItemDialog::Flags)
