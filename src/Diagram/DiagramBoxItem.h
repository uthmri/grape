...
#ifndef DIAGRAMBOXITEM_H
#define DIAGRAMBOXITEM_H

#include <DiagramBaseItems.h>

class DiagramBoxItem : public DiagramBoxResizeItem
{
public:
	DiagramBoxItem();
	DiagramBoxItem(const DiagramBoxItem& item);
	virtual ~DiagramBoxItem();
...
class DiagramBoxItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
	DiagramBoxItemDialog(QWidget* parent = NULL, Flags flags = NoFlags);
	~DiagramBoxItemDialog();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(DiagramBoxItemDialog::Flags)
