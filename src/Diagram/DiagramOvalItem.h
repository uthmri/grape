...
#ifndef DiagramOvalItem_H
#define DiagramOvalItem_H

#include <DiagramBaseItems.h>

class DiagramOvalItem : public DiagramBoxResizeItem
{
public:
    DiagramOvalItem();
    DiagramOvalItem(const DiagramOvalItem& item);
    virtual ~DiagramOvalItem();
...
class DiagramOvalItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
    DiagramOvalItemDialog(QWidget* parent = NULL, Flags flags = NoFlags);
    ~DiagramOvalItemDialog();
...
Q_DECLARE_OPERATORS_FOR_FLAGS(DiagramOvalItemDialog::Flags)
