...
int mpfit(mp_func funct, int m, int npar,
	  ...
	  mp_result *result)
{
   // printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit##number of parametres= %d\n",1)  ;
    //printf("     %f %f\n", pars[0], pars[1]);
  mp_config conf;
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 4 ##iteration= %d\n",iter)  ;
 ...
 //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 4_1_1 ##iteration= %d\n",iter)  ;
  /* Make a new copy */
  for (i=0; i<npar; i++) {
    xnew[i] = xall[i];
  }
...
//     printf("  P[0] = %f",pars[1]);
   ...
   // printf("parametr values: %f %f \n",pars[0],pars[1])  ;
    iter += 1;
  }
  //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 8_2_1 ##iteration= %d\n",iter)  ;
  /*
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 8_4 ##iteration= %d\n",iter)  ;
...

  {
   ...
   //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 8_5 ##iteration= %d\n",iter)  ;
//    if (result->covar) {

//        printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 8_6 ##iteration= %d\n",iter)  ;
//      /* Zero the destination covariance array */
//      for (j=0; j<(npar*npar); j++)
//      {
//           printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit 8_7 ##j= %d\n",j)  ;
//          result->covar[j] = 0;
//      }
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mpfit end##number of parametres= %d\n",1)  ;
  return info;
}
...
*/
 ...
 //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2##number of param= %d\n",npar)  ;
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_2##number of parametres= %d\n",npar)  ;
  ...
  if (has_numerical_deriv) for (j=0; j<n; j++) {  /* Loop thru free parms */
    ...
    //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_2_1##number of parametres= %d\n",npar)  ;
    /* Check for debugging */
    if (debug) {
      printf("FJAC PARM %d\n", ifree[j]);
    }
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_2_2##number of parametres= %d\n",npar)  ;
    x[ifree[j]] = temp + h;
    iflag = mp_call(funct, m, npar, x, wa, 0, priv);
    //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_2_3##number of parametres= %d\n",npar)  ;
    if (nfev) *nfev = *nfev + 1;
    if (iflag < 0 ) goto DONE;
    x[ifree[j]] = temp;
 ...
 //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_2_3##number of parametres= %d\n",npar)  ;
      iflag = mp_call(funct, m, npar, x, wa, 0, priv);
      // printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_2_4##number of parametres= %d\n",npar)  ;
      if (nfev) *nfev = *nfev + 1;
      if (iflag < 0 ) goto DONE;
      x[ifree[j]] = temp;
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2_3##number of parametres= %d\n",npar)  ;
  if (has_debug_deriv) {
 ...
 DONE:
   ...
   */
  //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_fdjac2 end##number of parametres= %d\n",npar)  ;
}
...
*/
 ...
 //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##3##number of parametres= %d\n",20)  ;
...
*/
  ...
  static double p25 = 0.25;
  static double p5 = 0.5;
   //printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##4##number of parametres= %d\n",30)  ;
  /*
	      ...
	      double *sdiag, double *wa1, double *wa2) 
{
  ...
  // printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_lmpar##number of parametres= %d\n",40)  ;
  /*
...
double mp_enorm(int n, double *x) 
{
  ...
  static double zero = 0.0;
  static double one = 1.0;
  // printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_enorm##number of parametres= %d\n",50)  ;
  s1 = zero;
  s2 = zero;
  s3 = zero;
  x1max = zero;
...
//printf("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&##mp_covar##number of parametres= %d\n",80)  ;
  /*
