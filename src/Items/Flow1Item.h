...
class Flow1Item : public DiagramBoxItem
{
protected:
...
public:
    Flow1Item();
    Flow1Item(const Flow1Item& item);
    ~Flow1Item();
...
class Flow1ItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
    Flow1ItemDialog(QWidget* parent = NULL);
    ~Flow1ItemDialog();
