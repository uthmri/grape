...
class LoopItem : public NodeItem
{
protected:
...
public:
    LoopItem(const NodeInterface &NI);
    LoopItem(const LoopItem& item);
    ~LoopItem();
...
//==================================================================================================
class LoopItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
//    QTextEdit* inputPathEdit;
    QDoubleSpinBox* startValueEdit;
    QDoubleSpinBox* stepEdit;
    QDoubleSpinBox* endValueEdit;
...
public:
    LoopItemDialog(QWidget* parent = NULL);
    ~LoopItemDialog();
