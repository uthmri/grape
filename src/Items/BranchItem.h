...
class BranchItem : public NodeItem
{
protected:
...
public:
    BranchItem(const NodeInterface &NI);
    BranchItem(const BranchItem& item);
    ~BranchItem();
...
//==================================================================================================
class BranchItemDialog : public DiagramItemPropertiesDialog
{
    Q_OBJECT
...
public:
    BranchItemDialog(QWidget* parent = NULL);
    ~BranchItemDialog();
