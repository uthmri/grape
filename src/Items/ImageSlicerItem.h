...
#ifndef ImageSlicerITEM_H
#define ImageSlicerITEM_H

#include <NodeItem.h>


class ImageSlicerItem : public NodeItem
{
protected:
...
public:
    ImageSlicerItem(const NodeInterface &NI);
    ImageSlicerItem(const ImageSlicerItem& item);
    ~ImageSlicerItem();
...
//==================================================================================================
class ImageSlicerItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
    ...
    ImageSlicerItemDialog(QWidget* parent = NULL);
    ~ImageSlicerItemDialog();
