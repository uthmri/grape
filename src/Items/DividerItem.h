...
class DividerItem : public NodeItem
{
protected:
...
public:
    DividerItem(const NodeInterface &NI);
    DividerItem(const DividerItem& item);
    ~DividerItem();
...
//==================================================================================================
class DividerItemDialog : public DiagramItemPropertiesDialog
{
    Q_OBJECT
...
public:
    DividerItemDialog(QWidget* parent = NULL);
    ~DividerItemDialog();
