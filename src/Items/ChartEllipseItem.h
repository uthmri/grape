...
#ifndef CHARTELLIPSEITEM_H
#define CHARTELLIPSEITEM_H

#include <DiagramEllipseItem.h>

class ChartEllipseItem : public DiagramEllipseItem
{
protected:
...
public:
	ChartEllipseItem();
	ChartEllipseItem(const ChartEllipseItem& item);
	~ChartEllipseItem();
...
class ChartEllipseItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
	ChartEllipseItemDialog(QWidget* parent = NULL);
	~ChartEllipseItemDialog();
