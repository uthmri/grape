...
class Flow3Item : public DiagramBoxItem
{
protected:
...
public:
    Flow3Item();
    Flow3Item(const Flow3Item& item);
    ~Flow3Item();
...
class Flow3ItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
    Flow3ItemDialog(QWidget* parent = NULL);
    ~Flow3ItemDialog();
