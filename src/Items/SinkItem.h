...
class SinkItem : public NodeItem
{
protected:
...
public:
    SinkItem(const NodeInterface &NI);
    SinkItem(const SinkItem& item);
    ~SinkItem();
    ...
    void setOutputType(const QString& dataType);
...
//==================================================================================================
//==================================================================================================
class SinkItemDialog : public DiagramItemPropertiesDialog
{
    //Q_OBJECT
...
private:
    ...
    int dataTypeIndex;
public:
    SinkItemDialog(QWidget* parent = NULL);
    ~SinkItemDialog();
