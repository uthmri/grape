...
#ifndef SystemcallITEM_H
#define SystemcallITEM_H

#include <NodeItem.h>


class SystemcallItem : public NodeItem
{
protected:
...
public:
    SystemcallItem(const NodeInterface &NI);
    SystemcallItem(const SystemcallItem& item);
    ~SystemcallItem();
...
//==================================================================================================
class SystemcallItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
    ...
    SystemcallItemDialog(QWidget* parent = NULL);
    ~SystemcallItemDialog();
