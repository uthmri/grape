...
class Flow2Item : public DiagramBoxItem
{
protected:
...
public:
    Flow2Item();
    Flow2Item(const Flow2Item& item);
    ~Flow2Item();
...
class Flow2ItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
public:
    Flow2ItemDialog(QWidget* parent = NULL);
    ~Flow2ItemDialog();
