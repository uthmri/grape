...
#ifndef CurveFittingITEM_H
#define CurveFittingITEM_H

#include <NodeItem.h>

#define MAX_CURVEFITTING_ARG 16

class CurveFittingItem : public NodeItem
{
protected:
...
public:
    CurveFittingItem(const NodeInterface &NI);
    CurveFittingItem(const CurveFittingItem& item);
    ~CurveFittingItem();
    ...
    // Selectors
    void setCurveFittingType(const QString& dataType);
    void setxData(const QString& arg1);
    void setparValue(const QString& arg2);
    void settrValue(const QString& arg3);
    void setArgValue(const QString& Arg_J, int j);

    void setCaption(const QString& caption);
    void setFont(const QFont& font);
	void setTextBrush(const QBrush& brush);
    QString CurveFittingType() const;
...
//==================================================================================================
class CurveFittingItemDialog : public DiagramItemPropertiesDialog
{
	Q_OBJECT
...
private:
    ...
    QLineEdit* xdataEdit;
    QLineEdit* parValueEdit;
    QLineEdit* trValueEdit;    

    QLineEdit* ArgValueEdit[MAX_CURVEFITTING_ARG];
    QLabel* ArgLabel[MAX_CURVEFITTING_ARG];


    int CurveFittingTypeIndex;
    QComboBox* CurveFittingTypeCombo;
...
public:
    ...
    CurveFittingItemDialog(QWidget* parent = NULL);
    ~CurveFittingItemDialog();
...
public slots:
    ...
    void FitModelChange(const QString& s);
